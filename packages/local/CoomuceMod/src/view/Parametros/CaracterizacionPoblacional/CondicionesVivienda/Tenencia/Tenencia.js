    ...
    items: [
        {
            ...
            columns: [
                { dataIndex: "idTenencia", header: "Id", hidden: true },
                {
                    dataIndex: "codigoTenencia", header: "Código", width: 100, editor: {
                        allowBlank: false
                    }
                },
                {
                    dataIndex: "nombreTenencia", header: "Nombre", width: 300, editor: {
                        allowBlank: false
                    }
                }
            ],
