    ...
    items: [
        {
            ...
            columns: [
                { dataIndex: "idTipoParentesco", header: "Id", hidden: true },
                {
                    dataIndex: "codigoTipoParentesco", header: "Código", width: 100, editor: {
                        allowBlank: false
                    }
                },
                {
                    dataIndex: "nombreTipoParentesco", header: "Nombre", width: 300, editor: {
                        allowBlank: false
                    }
                },
                {
                    dataIndex: "descripcionTipoParentesco", header: "Descripción", width: 300, editor: {
                        allowBlank: true
                    }
                }
            ],
