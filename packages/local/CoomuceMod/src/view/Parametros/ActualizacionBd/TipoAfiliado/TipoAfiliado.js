    ...
    items: [
        {
            ...
            columns: [
                { dataIndex: "idTipoAfiliado", header: "Id", hidden: true },
                {
                    dataIndex: "codigoTipoAfiliado", header: "Código", width: 100, editor: {
                        allowBlank: false
                    }
                },
                {
                    dataIndex: "nombreTipoAfiliado", header: "Nombre", width: 300, editor: {
                        allowBlank: false
                    }
                }
            ],
